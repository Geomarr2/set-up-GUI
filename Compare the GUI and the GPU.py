...
# obtain power in dBm from IQ voltageacquired through tektronix GUI
    ...
    # Load data IQ data
    matIQdata = scipy.io.loadmat('D:/Geomarr/tek signalVu/testdataIQdataFullRBW.mat')
    IQdata = matIQdata['Y']
    ...
    python, = plot_stiched_spectrum(spectrum, "k",displayResolution, yaxis, title, "Calculated using python FFT")
